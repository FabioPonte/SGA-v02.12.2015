...
#region Colunas
        ...
        static string Owarehouse;
        string warehouse;
        public string Warehouse
        {
            get { return warehouse; }
            set { warehouse = value; Add("warehouse"); _valorescusto.Add(value); }
        }
...
}if(Warehouse!=null){ Nomecusto.Add("warehouse");
 Valorcusto.Add(Owarehouse);
 _valorescusto.Add(Warehouse);
...
return ExecuteNonSql.Executar("custo", TipoDeOperacao.Tipo.UpdateCondicional, _colunacusto, _valorescusto, Condicaocusto);
        ...
        static public List<custo> Obter()
        {
            ...
            try {   novo.Warehouse = (string)tabela.Rows[a]["warehouse"]; Owarehouse = (string)tabela.Rows[a]["warehouse"]; } catch { }
                lista.Add(novo);
            }
            return lista;
        }
